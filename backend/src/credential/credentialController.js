...
async function receiveOffer(req, res) {
    try {
        ...
        const recordsResponse = await axios.get(
            'http://172.16.20.25:7011/issue-credential-2.0/records',
            {
                headers: {
...
console.log("\n\n\n\n\n\n\n hi \n\n\n\n\n\n");
        ...
        const acceptResponse = await axios.post(
            `http://172.16.20.25:7011/issue-credential-2.0/records/${credExId}/send-request`,
            {},
            {
                headers: {
        ...
        const requestUrl = `http://172.16.20.25:7011/issue-credential-2.0/records/${credExId}/store`;
        ...
        const credentialRecordResponse = await axios.get(
            `http://172.16.20.25:7011/credentials`,
            {
                headers: {
